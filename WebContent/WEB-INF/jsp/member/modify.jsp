...
<body>
    <div class="listpage">
        ...
        <div class="card-body">
            <p style="font-size: 20px; margin-bottom: 10px;"><b>정보수정</b></p>
                <form  class="form-signin"  method="post" onsubmit="return checkAll()"> 
                    <label for="id">아이디</label> 
                    <div class="input-box"> 
                        <input class="form-control"  id="id" type="text" name="id" placeholder="아이디" value="<%=((Member)session.getAttribute("member")).getId() %>" readonly> 
                    ...
                    <div class="input-box"> 
                       <input class="form-control"  id="pwdCk" type="password" name="pwd" placeholder="비밀번호확인" required>
                        <p class="msg text-danger"></p>
                    </div> 
                   ...
                   <button class="btn btn-lg btn-primary btn-block" type="submit" id="btnJoin">정보수정</button>
                </form>
                <a href="removeform"><input id="btnTal" class="btn btn-lg btn-primary btn-block" type="button" value="회원탈퇴"></a>
          </div>
      </div>
