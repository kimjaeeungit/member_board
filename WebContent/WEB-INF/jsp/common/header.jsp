...
<header class="pt-4">
	<div class="mt-4 clearfix">
		<a class="float-left mb-3" href="${pageContext.request.contextPath}/index.html"><img src = "${pageContext.request.contextPath}/images/logo.PNG" id="mainimg" alt="메인사진"  width="200px" height="70px" >
        </a>
