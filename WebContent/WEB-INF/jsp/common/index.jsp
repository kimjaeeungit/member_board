...
<body>
   ...
   <jsp:include page="header.jsp"/>
    ...
    <section id="main">
        <div id="main1">
       		<div class="slider">
            	<img alt="daisies" src="${pageContext.request.contextPath}/images/image7.jpg">
            	<img alt="plant" src="${pageContext.request.contextPath}/images/image8.jpg">
            	<img alt="ucculents" src="${pageContext.request.contextPath}/images/image9.jpg">
        	</div>
        </div>
        <div id="main2">
            ...
            <hr>
            <div id="main2img">
                <img src="images/product1.PNG" width="80" height="80" alt="패드">
                <p style="font-size: 16px">아몬스 국산 명품패드 소형 300매</p>
                <p>47,400원</p>
            </div>
            <div id="main2img">
                <img src="images/product3.PNG" width="80" height="80" alt="패드">
